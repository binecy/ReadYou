...
import me.ash.reader.domain.service.WebDavRssService
...
fun AddWebDavRssAccountDialog(
    ...
    RYDialog(
        ...
        visible = uiState.addWebDavRSSAccountDialogVisible,
        properties = DialogProperties(usePlatformDefaultWidth = false),
        onDismissRequest = {
            focusManager.clearFocus()
            accountViewModel.cancelAdd()
            viewModel.hideAddWebDavRSSAccountDialog()
        },
        icon = {
            if (accountUiState.isLoading) {
                ...
                Icon(
                    ...
                    contentDescription = stringResource(R.string.webdav),
                )
            }
        },
        title = {
            ...
            TextButton(
                ...
                onClick = {
                    ...
                    accountViewModel.addAccount(
                        ...
                        if (account == null) {
                            context.showToast(exception?.message ?: "Not valid password")
                        } else {
                            viewModel.hideAddWebDavRSSAccountDialog()
                            onBack()
